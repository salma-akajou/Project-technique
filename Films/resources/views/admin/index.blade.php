...
@section('content')
<div class="mx-auto" data-admin-root>
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <button id="adminAddFilmBtn" class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 shadow-md transition-all">
