    ...
    <div class="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm">
        <div class="flex flex-col lg:flex-row">
            ...
            <div class="lg:w-3/5 p-8 lg:p-12">
                ...
                <div class="space-y-6">
                    <div>
                        <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">{{ __('films.fields.director') }}</h3>
                    ...
                    <div>
                        <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">{{ __('films.fields.description') }}</h3>
